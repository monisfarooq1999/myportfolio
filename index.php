        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    I've danced with code, crafting worlds where dreams belong.</br>
                    From pixels to paths, I navigate with ease,</br>
                    Master of Shopify and WordPress, I build digital seas.</p>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <h2 class="text-primary fw-bold mb-0" data-toggle="counter-up">25</h2>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <h5 class="border-end pe-3 me-3 mb-0">Total Working Hours</h5>
                        <h2 class="text-primary fw-bold mb-0" data-toggle="counter-up">1200</h2>
                    </div>
